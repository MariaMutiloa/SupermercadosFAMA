...
//PRODUCTO
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('3', '001', 'Leche entera de vaca, 1 litro')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('2', '002', 'Huevos frescos, docena')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('5', '003' 'Pan de molde integral, 500g')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('1', '004', 'Manzanas, kilo')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('3', '005', 'Paquete de salchichas, 8 unidades')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('2', '006', 'Pasta de dientes, 75ml')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('3', '007', 'Refresco de naranja, 2 litros')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('6', '008', 'Papel higiénico, paquete de 6 rollos')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('4', '009', 'Caja de cereales integrales, 500g')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('2', '010', 'Yogur natural, 125g')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('3', '011', 'Barra de chocolate negro, 100g')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('2', '015', 'Bolsa de zanahorias, kilo')";
char *query = "INSERT INTO PRODUCTOS (importe, cod_prod, descripcion) VALUES ('5', '013', 'Aceite de oliva virgen extra, botella de 500ml')";
